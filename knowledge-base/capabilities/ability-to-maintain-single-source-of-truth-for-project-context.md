---
type: capability
title: Ability to maintain single source of truth for project context
...
upe:
  ...
  functional_block: 10.1 Data Model & Semantic Foundation
---
...
## Source
Functional block **10.1 Data Model & Semantic Foundation** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
