---
type: capability
title: Ability to maintain scalable knowledge capture (not manual 10-hour processes)
...
upe:
  ...
  functional_block: 5.1 Knowledge Capture & Representation
---
...
## Source
Functional block **5.1 Knowledge Capture & Representation** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
