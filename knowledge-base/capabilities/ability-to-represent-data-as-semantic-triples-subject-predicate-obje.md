---
type: capability
title: Ability to represent data as semantic triples (subject-predicate-object)
...
upe:
  ...
  functional_block: 5.2 Metadata Management & Semantic Integration
---
...
## Source
Functional block **5.2 Metadata Management & Semantic Integration** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
