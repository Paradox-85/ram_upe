---
type: capability
title: Ability to support real-time and batch processing
...
upe:
  ...
  functional_block: 10.3 Scalability & Performance
---
...
## Source
Functional block **10.3 Scalability & Performance** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
