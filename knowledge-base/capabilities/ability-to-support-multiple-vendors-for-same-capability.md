---
type: capability
title: Ability to support multiple vendors for same capability
...
upe:
  ...
  functional_block: 7.3 Vendor Independence & Interoperability
---
...
## Source
Functional block **7.3 Vendor Independence & Interoperability** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
