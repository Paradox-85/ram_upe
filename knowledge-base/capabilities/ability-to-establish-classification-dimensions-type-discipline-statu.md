---
type: capability
title: Ability to establish classification dimensions (type, discipline, status, etc.)
...
upe:
  ...
  functional_block: 4.1 Data Classification & Organization
---
...
## Source
Functional block **4.1 Data Classification & Organization** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
