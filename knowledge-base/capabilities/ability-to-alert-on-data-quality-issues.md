---
type: capability
title: Ability to alert on data quality issues
...
upe:
  ...
  functional_block: 12.2 Alerting & Incident Management
---
...
## Source
Functional block **12.2 Alerting & Incident Management** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
