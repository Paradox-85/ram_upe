---
type: capability
title: Ability to establish common vs. specific requirements
...
upe:
  ...
  functional_block: 11.2 GBA Requirements Aggregation
---
...
## Source
Functional block **11.2 GBA Requirements Aggregation** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
