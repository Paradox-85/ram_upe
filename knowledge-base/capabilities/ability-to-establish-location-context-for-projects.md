---
type: capability
title: Ability to establish location context for projects
...
upe:
  ...
  functional_block: 14.1 BIM/GIS & Visualization Capabilities
---
...
## Source
Functional block **14.1 BIM/GIS & Visualization Capabilities** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
