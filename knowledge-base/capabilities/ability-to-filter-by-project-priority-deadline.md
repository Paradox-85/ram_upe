---
type: capability
title: Ability to filter by project, priority, deadline
...
upe:
  ...
  functional_block: 9.3 Multi-Project & Multi-Context Support
---
...
## Source
Functional block **9.3 Multi-Project & Multi-Context Support** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
