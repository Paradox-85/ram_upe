---
type: capability
title: Ability to aggregate data from multiple projects
...
upe:
  ...
  functional_block: 9.2 Dashboards & Reporting
---
...
## Source
Functional block **9.2 Dashboards & Reporting** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
