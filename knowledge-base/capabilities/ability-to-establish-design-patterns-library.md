---
type: capability
title: Ability to establish design patterns library
...
upe:
  ...
  functional_block: 10.5 Documentation & Knowledge Management
---
...
## Source
Functional block **10.5 Documentation & Knowledge Management** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
