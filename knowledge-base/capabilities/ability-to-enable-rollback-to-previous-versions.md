---
type: capability
title: Ability to enable rollback to previous versions
...
upe:
  ...
  functional_block: 8.2 Approval & Governance Workflows
---
...
## Source
Functional block **8.2 Approval & Governance Workflows** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
