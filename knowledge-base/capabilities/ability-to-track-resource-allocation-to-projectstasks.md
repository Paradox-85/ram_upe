---
type: capability
title: Ability to track resource allocation to projects/tasks
...
upe:
  ...
  functional_block: 14.2 Time Reporting & Resource Management
---
...
## Source
Functional block **14.2 Time Reporting & Resource Management** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
