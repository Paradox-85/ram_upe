---
type: capability
title: Ability to support billing from contracts
...
upe:
  ...
  functional_block: 14.3 Contracting & Legal Compliance
---
...
## Source
Functional block **14.3 Contracting & Legal Compliance** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
