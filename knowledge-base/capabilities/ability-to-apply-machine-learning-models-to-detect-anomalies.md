---
type: capability
title: Ability to apply machine learning models to detect anomalies
...
upe:
  ...
  functional_block: 6.1 AI-Powered Rules & Compliance Checking
---
...
## Source
Functional block **6.1 AI-Powered Rules & Compliance Checking** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
