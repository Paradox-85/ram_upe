---
type: capability
title: Ability to establish role-based access control (RBAC)
...
upe:
  ...
  functional_block: 10.4 Security & Access Control
---
...
## Source
Functional block **10.4 Security & Access Control** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
