---
type: capability
title: Ability to define project roles (PM, Designer, Engineer, Reviewer, etc.)
...
upe:
  ...
  functional_block: 2.3 Role & Responsibility Management
---
...
## Source
Functional block **2.3 Role & Responsibility Management** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
