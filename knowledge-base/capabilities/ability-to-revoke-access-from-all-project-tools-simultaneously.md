---
type: capability
title: Ability to revoke access from all project tools simultaneously
...
upe:
  ...
  functional_block: 2.2 User Offboarding & Access Revocation
---
...
## Source
Functional block **2.2 User Offboarding & Access Revocation** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
