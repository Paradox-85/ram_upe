---
type: capability
title: Ability to support AI-assisted code generation (GitHub Copilot, Claude, etc.)
...
upe:
  ...
  functional_block: 6.2 AI-Powered Code Generation & Automation
---
...
## Source
Functional block **6.2 AI-Powered Code Generation & Automation** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
