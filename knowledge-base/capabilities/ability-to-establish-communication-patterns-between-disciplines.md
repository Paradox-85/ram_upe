---
type: capability
title: Ability to establish communication patterns between disciplines
...
upe:
  ...
  functional_block: 8.1 Process Embedding in Tools
---
...
## Source
Functional block **8.1 Process Embedding in Tools** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
