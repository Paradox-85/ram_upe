---
type: capability
title: Ability to define master data entities (materials, components, standards, etc.)
...
upe:
  ...
  functional_block: 4.3 Master Data & Reference Data Management
---
...
## Source
Functional block **4.3 Master Data & Reference Data Management** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
