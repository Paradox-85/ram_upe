---
type: capability
title: Ability to enable vendor out-of-box AI (Autodesk, Tier 1/2 vendors)
...
upe:
  ...
  functional_block: 6.4 AI Implementation Strategy
---
...
## Source
Functional block **6.4 AI Implementation Strategy** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
