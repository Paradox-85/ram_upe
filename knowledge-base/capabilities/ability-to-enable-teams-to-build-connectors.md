---
type: capability
title: Ability to enable teams to build connectors
...
upe:
  ...
  functional_block: 13.2 Enabler Development & Tooling
---
...
## Source
Functional block **13.2 Enabler Development & Tooling** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
