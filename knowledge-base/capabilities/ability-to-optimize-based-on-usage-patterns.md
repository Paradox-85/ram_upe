---
type: capability
title: Ability to optimize based on usage patterns
...
upe:
  ...
  functional_block: 12.1 System Health & Performance Monitoring
---
...
## Source
Functional block **12.1 System Health & Performance Monitoring** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
