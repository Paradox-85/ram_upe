---
type: capability
title: Ability to track deliverable status (not started, in progress, complete, delivered)
...
upe:
  ...
  functional_block: 3.1 Work Structure Definition
---
...
## Source
Functional block **3.1 Work Structure Definition** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
