---
type: capability
title: Ability to develop new connectors for additional systems
...
upe:
  ...
  functional_block: 7.2 Connector & Adapter Development
---
...
## Source
Functional block **7.2 Connector & Adapter Development** in [`raw-input/docs/UPE_Functional_Blocks_v1.md`](../raw-input/docs/UPE_Functional_Blocks_v1.md).
